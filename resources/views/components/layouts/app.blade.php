...
<body class="bg-amber-400 h-screen grid place-items-center" 
x-data="{
    appname: 'TT',
    message: 'The best athphp artisan make:component layouts.app --viewlete wants his opponent at his best.'
}">
    {{ $slot }}


    {{-- Global Filament Stuff Here --}}
