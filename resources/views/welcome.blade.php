...
<body class="bg-amber-400 h-screen grid place-items-center" x-data="{
    appname: 'TT'
}">
    <div class="size-12 text-white bg-black flex items-center justify-center">
